...
package com.hotpatch.hack.res.tinker;
...
import static com.hotpatch.hack.res.tinker.ShareReflectUtil.findConstructor;
import static com.hotpatch.hack.res.tinker.ShareReflectUtil.findField;
import static com.hotpatch.hack.res.tinker.ShareReflectUtil.findMethod;
...
public class TinkerResourcePatcher {
    ...
    public static void monkeyPatchExistingResources(Context context, String externalResourceFile) throws Throwable {
        LogUtil.i("monkeyPatchExistingResources");
        ...
        if (shouldAddSharedLibraryAssets(appInfo)) {
            for (String sharedLibrary : appInfo.sharedLibraryFiles) {
                ...
                LogUtil.i("addAssetPathAsSharedLibrary " + sharedLibrary);
            }
        }
...
//            throw new TinkerRuntimeException(ShareConstants.CHECK_RES_INSTALL_FAIL);
    ...
    private static void clearPreloadTypedArrayIssue(Resources resources) {
        ...
        //     return;
        // }
        LogUtil.w("try to clear typedArray cache!");
        ...
        try {
            ...
            LogUtil.e("clearPreloadTypedArrayIssue failed, ignore error: " + ignored);
        }
    }
    ...
    private static boolean checkResUpdate(Context context) {
        ...
        try {
            ...
            LogUtil.e("checkResUpdate failed, can't find test resource assets file " + TEST_ASSETS_VALUE + " e:" + e.getMessage());
            return false;
        } finally {
            closeQuietly(is);
        }
        LogUtil.i("checkResUpdate success, found test resource assets file " + TEST_ASSETS_VALUE);
        return true;
    }
